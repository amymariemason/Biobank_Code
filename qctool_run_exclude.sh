...
#OUTPUT: one .bgen file, containing the extracted snps for that chr in .bgen format, including only European unrelated samples
...
-og "${output_dir}/${output_name}.bgen" -incl-positions "${input_snps}" -excl-sample -s /scratch/am2609/Gwas/input_all/exclusion_list.txt
